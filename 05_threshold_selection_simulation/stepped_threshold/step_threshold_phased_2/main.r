##  step_threshold_phased/main.r
###
## Selecting a stepped threshold when censoring increases exponentially below
...
print(paste0("This is step_threshold_phased_2/main.r, where jobid = ", jobid, "."))
...
cat_range <- (jobid - 1) * 30 + 1:30

#_______________________________________________________________________________
###
## Function that calculates reciporical of d(q,1) for a proposed threshold ----
###
FUN_2 <- function(threshold_1, threshold_2){
  step_length_1 <- floor(n_1)
