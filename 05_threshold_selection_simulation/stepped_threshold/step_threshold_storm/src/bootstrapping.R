...
#'  verbose = TRUE)
#'
bootstrap_catalogues_step <- function(gpd_mle, u, n_v_mle, v_step_points, v_step_values, to_nearest, n_cats, verbose = TRUE) {
  ...
  cat_sizes <- rpois(n = n_cats, lambda = n_v_mle)
