...
###
print("calculating expedcted exceedances")
...
for(i in seq_along(thresholds)){
  ...
  mle_samples[[i]] <- sample_mles_gpd_rd_stepped(
    ...
    expected_exceedances = expected_exceedances[[i]],
    to_nearest = 0.1,
    n_sim = 750,
    verbose = TRUE)
}
...
print(paste0("pp_EWMSE chose:" , v_values, "."))
print(paste0("pp_EWMAE chose:" , v_values, "."))
print(paste0("qq_EMSE  chose:" , v_values, "."))
print(paste0("qq_EMAE  chose:" , v_values, "."))
