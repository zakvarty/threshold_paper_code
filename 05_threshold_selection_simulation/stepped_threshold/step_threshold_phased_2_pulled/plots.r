...
head(selected)
plot(selected, main = "BO selections, change location known")
pairs(selected, main = "BO selections, change location known", diag.panel = )
points(x = v[1], y = v[2], pch = 16,col = 2)
plot(catalogue_sizes$n_total)
plot(density(selected$threshold_1, na.rm = TRUE))
