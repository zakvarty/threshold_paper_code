##  batch_flat_thresh_minimal.r
###
## Runs same code as batch_flat_thresh.r but saves minimal output, only saving
## the threshold that is selected by each metric for each jobid.
###
## Author: Zak Varty
##
...
print(paste0("This is batch_flat_thresh.r, where jobid = ", jobid, "."))
...
# pdf(file = paste0("output/qq_flat_threshold_sim_multiple/cat_plots/cat_",seed_index,".pdf"),
#     width = 7,
#     height =5)
