...
#'
get_mle_and_bootstrap_exp <- function(cat, threshold, to_nearest, u, n_bootstrap_mles = 0, verbose = TRUE ){
  ...
  if(n_bootstrap_mles > 0){
    #warning("Bootstraping not limited to exponential! Do not trust!")
    ...
    mle_samples <- sample_mles_exp_rd_stepped(
      mle = MLE$params,
      u = u,
